...
export const docs: DocEntry[] = [
  ...
  { slug: "special-offer", title: "Special Offer", description: "Второй paywall из placement и простой циклический таймер на 24 часа.", group: "Монетизация", body: specialOffer },
  { slug: "adapty-setup", title: "Adapty и placements", description: "Публичный SDK key, placement ID и все продукты из ответа Adapty.", group: "Монетизация", body: adaptySetup },
  ...
  { slug: "token-paywall", title: "Token paywall", description: "Все token packages из placement без скрытой фильтрации.", group: "Монетизация", body: tokenPaywall },
