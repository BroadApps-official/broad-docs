...
export const docs: DocEntry[] = [
  ...
  { slug: "ru-billing", title: "Оплата картой и СБП", description: "Точное правило ru_pay, Storefront/региона, каталога и подтверждения оплаты.", purpose: "Безопасно добавить СБП и карту рядом с Apple без ложного Premium.", when: "Когда подключаете, проверяете или обновляете RU Billing.", outcome: "Понятно, когда показать RU methods, откуда взять продукты и почему возврат из браузера ещё не успех.", group: "Монетизация", body: ruBilling },
  { slug: "backend-product-catalog", title: "Продукты с backend для RU Billing", description: "Где сделать HTTP-запрос, как разобрать JSON и сохранить все тарифы без потерь.", purpose: "Подключить app-specific backend к общей платёжной логике через готовый или собственный decoder.", when: "Когда backend отдаёт продукты для СБП и карты.", outcome: "Каждая строка каталога проверена, сохранена в исходном порядке и точно связана с продуктом Adapty/App Store.", group: "Монетизация", body: backendProductCatalog },
