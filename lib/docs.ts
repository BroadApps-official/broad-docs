...
export const docs: DocEntry[] = [
  { slug: "getting-started", title: "Первое подключение", description: "Выберите одну нужную часть платформы, добавьте её в Xcode и убедитесь, что приложение работает.", purpose: "Подключить готовый общий код без лишних библиотек.", when: "Когда добавляете BroadApps в новый или существующий Xcode-проект.", outcome: "Выбранная библиотека загружена, приложение собирается и нужная функция открывается.", group: "Старт", body: gettingStarted },
  ...
  { slug: "module-selection", title: "Какую часть платформы выбрать", description: "Назовите нужную функцию приложения и получите точное название одной библиотеки для Xcode.", purpose: "Не подключать всю платформу, когда приложению нужна одна функция.", when: "До добавления библиотеки в Xcode.", outcome: "Вы знаете, какую библиотеку добавить; всё обязательное Xcode загрузит автоматически.", group: "Старт", body: moduleSelection },
  ...
  { slug: "ru-billing", title: "Оплата картой и СБП", description: "Когда можно показать российскую оплату и почему простой возврат из банковского окна ещё не означает успех.", purpose: "Безопасно добавить оплату через сервер приложения.", when: "Когда подключаете СБП или банковскую карту вместо оплаты Apple.", outcome: "Экран появляется только при выполненных условиях, а Premium открывается после ответа сервера.", group: "Монетизация", body: ruBilling },
  { slug: "architecture", title: "Как устроена платформа", description: "Как выбрать одну библиотеку, что Xcode скачает автоматически и где должен жить каждый вид кода.", purpose: "Понять платформу от задачи приложения до зависимостей, данных и владельца изменения.", when: "Перед первым подключением, изменением общей библиотеки или разбором спорного решения.", outcome: "Вы знаете, какой product добавить, что придёт автоматически и какой репозиторий менять.", group: "Архитектура", body: architecture },
