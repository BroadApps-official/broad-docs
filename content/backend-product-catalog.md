...
Decoder сохраняет все строки и их отметки. Затем обычный paywall использует
обычные продукты, а RU Special Offer — продукт с `isSpecialOffer = true`,
...
точного совпадения RU method не показывается для этой обычной карточки.
