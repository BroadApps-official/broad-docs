...
`kupon = true` и отдельный RU-продукт. На примере 232 Claude это
`monthly_12.99_nottrial` с `widgetTitle = "kupon"` и ценой 990 ₽. При `true`
оффер показывается всегда, без таймеров и дополнительных условий.
