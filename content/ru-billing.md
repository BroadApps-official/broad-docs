...
Спешл оффер для RU Billing пока не входит в эту инструкцию: его правила ещё не
согласованы. Текущая страница
[«Спешл оффер (от Adapty)»](./special-offer.md) описывает только Adapty-flow.
