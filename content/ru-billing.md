...
**Правило обновлено 9 сентября 2026 года, BroadMonetization 1.5.2 (API с 1.5.0).** Резервный
...
1. Обновите BroadMonetization до **1.5.2** вместе с проверенным набором платформы.
...
на `main`. Если настроенный `main` тоже недоступен, проверяется RU-резерв.
