...
| Сочетание проверенных версий | [Compatibility/current.yml](https://github.com/BroadApps-official/broad-platform-integration/blob/main/Compatibility/current.yml) | Набор 5.1.0: Core 3.0.0, Extensions 1.0.1, Monetization 5.1.0, UIFlows 5.0.0, опциональный RU Billing 1.0.0 |
...
Схемы структуры и подключения в `public/guides/readme/architecture-light.svg`, `composition-root-light.svg` и `full-flow-light.svg` поддерживаются в этом репозитории. При изменении модулей обновляйте их вместе с главной страницей и статьями; не заменяйте схемы сайта старой копией из integration.
