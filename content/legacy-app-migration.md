...
- СБП или карту — только если старое приложение уже имеет утверждённый собственный backend-контракт, и только на безопасных тестовых данных; в новое подключение RU Billing пока не добавлять;
