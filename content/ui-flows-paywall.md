...
|---|---|
| Крестик обычного paywall | Special Offer открывается только по согласованному флагу |
| Успешные purchase и restore | Второе предложение не открывается |
| Продукт Special Offer | Используется только отдельно подтверждённый продукт |
| Повторный tap | Вторая операция не запускается |
| Loader | Выбранный продукт сохраняется |
| Крестик Special Offer | Бесплатный маршрут завершается |
