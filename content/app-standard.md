...
> [!CAUTION]
> **ПЕРЕД ПЕРЕДАЧЕЙ СБОРКИ УДАЛИТЕ КОММЕНТАРИИ ИЗ ВСЕХ ФАЙЛОВ ПРОЕКТА**
> Проверьте исходники, настройки и скрипты: удалите поясняющие комментарии, TODO/FIXME и закомментированный код. Нужные объяснения перенесите в документацию. Служебные директивы инструментов и обязательные лицензионные уведомления сохраняйте. После очистки заново соберите приложение.
