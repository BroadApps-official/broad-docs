...
> [!CAUTION]
> **ПЕРЕД ПЕРЕДАЧЕЙ СБОРКИ УДАЛИТЕ ШАПКИ КОММЕНТАРИЕВ ИЗ ВСЕХ ФАЙЛОВ ПРОЕКТА**
> Речь о шапках с названием файла, проекта, автором и датой создания — как на примере ниже.
> ![Пример шапки комментариев, которую нужно удалить: название файла и проекта, Created by, имя автора и дата.](../public/guides/project-standard/file-header-comments.png)
