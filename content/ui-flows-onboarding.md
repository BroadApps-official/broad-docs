...
![Второй реальный онбординг с дополнительным экраном оценки](../public/guides/ui-flows/sample-assistant/onboarding.gif)
...
| момент завершения онбординга | нужна ли страница оценки |
