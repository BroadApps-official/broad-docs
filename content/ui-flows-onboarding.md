...
## 5007: обновлённый онбординг

В актуальной сборке 5007 три шага. Каждый Continue меняет один экран, а
последний Continue открывает обычный paywall. На GIF показан весь переход по
трём страницам без системного окна ATT.

![5007: три экрана обновлённого онбординга](../public/guides/ui-flows/5007/onboarding.gif)

Первый экран сразу объясняет основную пользу приложения, а последний завершает
историю и подводит к paywall.

![5007: первый экран обновлённого онбординга](../public/guides/ui-flows/5007/onboarding.png)

![5007: последний экран обновлённого онбординга](../public/guides/ui-flows/5007/onboarding-final.png)
...
- последняя страница ведёт в обычный paywall или на главный экран приложения по продуктовому маршруту;
...
| переход к paywall или на главный экран приложения | какой маршрут нужен продукту |
...
ATT, если он действительно нужен
        ↓
обычный paywall или сразу главный экран приложения
```
...
6. Последняя страница ведёт ровно в согласованный paywall или на главный экран приложения.
