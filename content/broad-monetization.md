...
Пока общий RU Billing-контракт не завершён командой, эту часть следует считать расширением на будущее: не включать её только по локальному флагу и не копировать серверные предположения из другого приложения.
