...
Текущее общее правило: свежий `ru_pay=true` **и** российский Storefront или
регион iPhone, затем точный продукт backend и серверное разрешение. Язык ничего
не включает, а отсутствующий флаг не превращается в `true`. Полный контракт и
матрица переходов находятся на странице [«Оплата картой и СБП»](./ru-billing.md),
а JSON/transport — в [инструкции каталога](./backend-product-catalog.md).
