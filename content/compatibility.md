...
приложении. RU Billing пока остаётся будущей работой; статус `passed` в этом
каталоге подтверждает сборку его контрактов, но не разрешает подключать карту
или СБП без утверждённого app/backend-контракта.
