...
|---|---|---|
| Номер набора — platform set | `1.5.2` | Обозначает сочетание ниже, не устанавливается как пакет |
...
| [BroadMonetization](https://github.com/BroadApps-official/broad-monetization-ios/releases/tag/1.5.4) | `1.5.4` | Покупки, восстановление, RU Billing, A/B и все резервные `isDefault` при отсутствии продуктов или совпадений ID |
...
**Не нужно ставить всем модулям номер 1.5.2.** У каждого свой выпуск. Не нужно и подключать все четыре модуля: сначала выберите [нужные возможности](./module-selection.md).
