...
UIFlows содержит интерфейс выбора способа оплаты и управления российской подпиской. Но бизнес-правила и подтверждение платежа остаются за сервером приложения. Мы пока не считаем RU Billing полностью универсальным готовым сценарием: его следует подключать только вместе с согласованным backend-контрактом.
