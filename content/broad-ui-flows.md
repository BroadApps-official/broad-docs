...
управления российской подпиской. Это **не готовый общий сценарий версии 1.0.0**.
Для нового приложения RU Billing пока не подключаем: сначала команда должна
утвердить app/backend-контракт, статусы, восстановление, юридический маршрут и
QA. Наличие экранов в package не заменяет эти решения.
