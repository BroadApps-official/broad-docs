...
Точные версии в этом разборе взяты из проверенного набора **platform set 1.4.0**. Для другого проекта смотрите [каталог совместимости](./compatibility.md); номер набора не нужно подставлять как версию каждого модуля.

| Пакет | Exact Version в наборе 1.4.0 | Product |
|---|---|---|
| `broad-core-ios` | `1.2.0` | `BroadCore` |
| `broad-extensions-ios` | `1.0.1` | `BroadExtensions` |
| `broad-monetization-ios` | `1.4.1` | `BroadMonetization` |
| `broad-ui-flows-ios` | `1.1.0` | `BroadUIFlows` |
