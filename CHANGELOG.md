...
- Определение BroadApps iOS стало главным крупным чёрным заголовком вводного блока.
- «Готовые части для iOS-приложений компании» перенесено в спокойный подзаголовок.
