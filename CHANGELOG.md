...
- Инструкция сокращена до действий разработчика: одна команда создаёт и загружает `release/<версия>`, после чего разработчик выбирает эту ветку в Codemagic. Убран пример отдельного приложения.
