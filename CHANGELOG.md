...
- Добавлены пять настоящих снимков актуальных примеров модулей в iPhone Simulator
  и использован снимок выбора product в Xcode. Старый пример со смешанными валютами
  убран из обзора UIFlows; демонстрационные данные новых снимков явно подписаны.
