...
const useCases = [
  ...
  { code: "OFFER", title: "Показать спешл оффер от Adapty", detail: "При special_offer = true показывать второй экран в активном 24-часовом окне, затем выдерживать cooldown 24 часа.", slug: "special-offer" },
  ...
  { code: "RU OFFER", title: "Настроить RU Special Offer", detail: "Флаг Adapty → продукт каталога с isSpecialOffer → RU checkout.", slug: "ru-special-offer" },
