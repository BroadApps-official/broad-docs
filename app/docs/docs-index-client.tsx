...
const useCases = [
  ...
  { code: "UI PAY", title: "Увидеть paywall и Special Offer", detail: "Общий сценарий платформы и отдельно — частные примеры 5007, 5092 и Claude232.", slug: "ui-flows-paywall" },
  ...
  { code: "OFFER", title: "Показать спешл оффер от Adapty", detail: "Флаг special_offer основного paywall, все продукты отдельного placement, окно 24 часа и cooldown 24 часа.", slug: "special-offer" },
