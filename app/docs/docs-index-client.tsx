...
const useCases = [
  ...
  { code: "RU OFFER", title: "Повторить RU Special Offer из 232", detail: "kupon = true → nextgenwebapps → widgetTitle == kupon → monthly_12.99_nottrial.", slug: "ru-special-offer" },
  { code: "МЕНЕДЖЕР", title: "Настроить RU Special Offer и A/B-тест", detail: "Проверить продукт в nextgenwebapps, включить gate Adapty и передать разработчику одну карточку.", slug: "ru-billing-account-manager" },
