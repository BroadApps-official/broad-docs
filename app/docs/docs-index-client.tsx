...
const useCases = [
  ...
  { code: "RU OFFER", title: "Добавить RU Billing: спешл оффер", detail: "Сначала подключить RU Billing, затем при special_offer = true всегда загрузить точный RU-продукт.", slug: "ru-special-offer" },
