    ...
    <div className="platform-map" aria-label="Схема подключения модулей BroadApps iOS">
      <div className="platform-map-head">
        <div>
          ...
          <b>Приложение выбирает модули. Служебные репозитории помогают, но в app не подключаются.</b>
        </div>
      ...
      <div className="platform-map-main">
        <div className="map-host">
          ...
          <small>host app</small>
          <p>Подключает один или несколько нужных Swift Package products.</p>
        </div>
        ...
        <div className="map-products">
          ...
          <div className="map-products-grid">
            <div className="map-product map-extensions">
              <b>Extensions</b>
              <small>самостоятельные utility</small>
              <em>без других модулей</em>
            </div>

            <div className="map-chain" aria-label="Зависимости UIFlows, Monetization и Core">
              <div className="map-product map-flows"><b>UIFlows</b><small>готовые SwiftUI-flow</small></div>
              <div className="map-dependency"><span>использует</span>↓</div>
              <div className="map-product map-money"><b>Monetization</b><small>покупки и entitlement</small></div>
              <div className="map-dependency"><span>использует</span>↓</div>
              <div className="map-product map-core"><b>Core</b><small>bootstrap, cache, logs</small></div>
            </div>
          </div>
        </div>
      </div>
