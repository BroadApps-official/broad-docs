    ...
    <footer className="site-footer">
      <div className="footer-inner section-wrap">
        ...
        <nav className="footer-links" aria-label="Навигация в подвале">
          ...
          <Link href="/docs/special-offer">Спешл оффер (Adapty)</Link><Link href="/docs/ru-special-offer">Спешл оффер RU Billing</Link><Link href="/docs/ru-billing">RU Billing</Link><Link href="/docs/compatibility">Совместимость</Link>
        </nav>
