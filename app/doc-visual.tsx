...
const simpleVisuals: Record<string, SimpleVisualContent> = {
  ...
  "ru-billing": {
    label: "КАРТА И СБП · БУДУЩЕЕ РАСШИРЕНИЕ",
    title: "Контракты в платформе есть, но готового общего подключения пока нет",
    steps: [
      ["СЕЙЧАС", "Не включать в приложении", "не копировать флаги и серверные правила из другого продукта"],
      ["СНАЧАЛА", "Утвердить контракт", "backend, статусы, восстановление, юридические экраны и QA"],
      ["ПОТОМ", "Подключить и проверить", "результат всегда подтверждает сервер приложения"],
    ],
    result: "До утверждения общего контракта страница служит границей будущей работы, а не инструкцией для немедленной интеграции.",
  },
  "onboarding-att": {
