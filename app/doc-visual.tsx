...
const simpleVisuals: Record<string, SimpleVisualContent> = {
  ...
  "backend-product-catalog": {
    ...
    title: "Приложение делает HTTP, платформа проверяет и сохраняет весь массив",
    steps: [
      ["01", "Backend отдаёт JSON", "стабильные ID, цена, валюта и доступные способы оплаты"],
      ["02", "App transport получает Data", "URL, auth и timeout остаются в конкретном приложении"],
      ["03", "Decoder создаёт модели 1:1", "каждая строка, исходный порядок и дубли сохраняются"],
